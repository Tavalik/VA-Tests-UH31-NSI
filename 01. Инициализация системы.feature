...
Контекст:
	И я подключаю TestClient "УХ31 НСИ" логин "" пароль "" 
	И Я закрыл все окна клиентского приложения

Сценарий: Создание пользователя системы [Администратор]
...
Сценарий: Включение подсистемы Корпоративные закупки
